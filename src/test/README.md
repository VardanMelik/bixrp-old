...
Unit tests are bundled in the `bixd` executable and can be executed using the
...
must specify it by suite or full-name (e.g. `bixd.app.NoBixdCheckLimits` or
just `NoBixdCheckLimits`).
